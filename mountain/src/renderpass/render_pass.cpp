...
//			   "failed to create render pass!");
    ...
    vk::AttachmentDescription fill_depth_stencil(SubPass const &subpass, vk::Format const &depth) {
        ...
        depth_attachment.loadOp =
                subpass.attachment_depth_stencil & subpass_attachment::DEPTH ? vk::AttachmentLoadOp::eClear
                                                                             : vk::AttachmentLoadOp::eDontCare;
        depth_attachment.storeOp = vk::AttachmentStoreOp::eDontCare;
        depth_attachment.stencilLoadOp =
                subpass.attachment_depth_stencil & subpass_attachment::STENCIL ? vk::AttachmentLoadOp::eClear
                                                                               : vk::AttachmentLoadOp::eDontCare;
