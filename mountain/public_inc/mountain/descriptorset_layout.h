...
namespace mountain::descriptorset_layout {
         ...
         */
        MOUNTAINAPI_EXPORT vk::DescriptorSetLayoutBinding create_descriptor_uniform(int binding, vk::ShaderStageFlags const &shader);
        /**
         ...
         * @return Corresponding descriptor set layout binding
         */
        MOUNTAINAPI_EXPORT vk::DescriptorSetLayoutBinding create_descriptor_image_sampler(int binding, vk::ShaderStageFlags const &shader);
        /**
         ...
         */
        MOUNTAINAPI_EXPORT vk::DescriptorSetLayout create_descriptorset_layout(Context const &context,
